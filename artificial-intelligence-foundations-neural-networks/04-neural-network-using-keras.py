...
plt.savefig("figure 04-01-heat-map.png")
...
plt.tight_layout()
# display(plt.show())
plt.savefig("figure 04-02-heat-map-correlation-matrix.png")
...
plt.savefig("figure 04-03-heat-map-gradiant-coloring.png")
...
for i, col in enumerate(
    ...
    plt.savefig(f"figure 04-04-${i}.png")
