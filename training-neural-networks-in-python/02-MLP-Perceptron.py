...
print("Gate: AND")
print("0 0 = {0:.10f} [{0:.1f}]".format(neuron.run([0, 0])))
print("0 1 = {0:.10f} [{0:.1f}]".format(neuron.run([0, 1])))
print("1 0 = {0:.10f} [{0:.1f}]".format(neuron.run([1, 0])))
print("1 1 = {0:.10f} [{0:.1f}]".format(neuron.run([1, 1])))
